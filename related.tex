...
\reminder{for Yoav: Please add: \paragraph{Works from ML and statistical signal processing communities} \cite{adaptive_filter_theory, dsp, prediction_learning_models, adaptive_signal_processing}}
...
\reminder{Add something on Approximate query processing}
